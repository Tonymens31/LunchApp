...
const getUserDetailsByUserIdAPI = (userId) => `${omsAPI}/Users/GetAspNetUsersById/${userId}`;
const changePasswordAPI = () => `${omsAPI}/Users/PostChangePassword`;

const postPricingAPI = () => `${omsAPI}/Pricing/PostPricing`;
const searchingPricingAPI = (filter) => `${omsAPI}/Pricing/GetAllPricings/${filter}`;
const putPricingAPI = () => `${omsAPI}/Pricing/PutPricing`;
const deletePricingAPI = (priceId) => `${omsAPI}/Pricing/DeletePricing/${priceId}`;

const getDashboardDataAPI = () => `${omsAPI}/Dashboard/GetDashboardDataAsync`;
